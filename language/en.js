export default {
	...
	my: {
		home: {
			...
			aboutUs: {
				...
				introduction:
					'BCAC Wallet is a mobile light wallet APP designed to provide ordinary users with a secure, easy-to-use, powerful digital asset wallet application.',
	...
	public: {
		...
		privateKey_ps:
			'PS: The user can use the plaintext private key to import BCAC Wallet, generate a new Keystore with a new password (remember to delete the old Keystore), and use this method to modify the wallet password.'
	},
	lock:{
		lock: "Lock",
		lockTransferRecord: "Transfer Record",
		lockToken: "Lock Token",
		watchAddress: {
			addressManager: "Address Management",
			addAddress: "Add Watch Address",
			wrongAddress: "Invalid Address",
			existAddress: "Existed Address",
		}
	}	
};
